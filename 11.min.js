...
1)+"END"+e};h.enumerateString=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="text"in arguments[0]?arguments[0].text:"":typeof a==="undefined"&&(a="");if(a.match(/\n/)!==null){var d=a.split("\n"),e=Infinity,b,f=!0;if(d[0].match(/^ +/)===null)for(var c=1;c<d.length;c++){var l=d[c].replace(/^( +|\t+)[^\1][\s\S]*$/,"$1");if(l!==d[c]){if(l.charAt(0)!==b&&c>1){f=!1;break}e=Math.min(l.length,e);b=l.charAt(0)}else e=0}if(e>0&&e<Infinity&&f===!0){for(c=1;c<d.length;c++)d[c]=
d[c].substring(e,d[c].length);a=d.join("\n")}}this.placeholders.strings.push(a);return"@PLACEHOLDERSTRINGS"+(this.placeholders.strings.length-1)+"END"};h.enumerateBlockComment=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="text"in arguments[0]?arguments[0].text:"":typeof a==="undefined"&&(a="");var d="";a.charAt(0)!=="/"&&(d=a.charAt(0),a=a.substring(1,a.length));this.placeholders.blockcomments.push(a);return d+"@PLACEHOLDERBLOCKCOMMENTS"+(this.placeholders.blockcomments.length-
1)+"END"};h.enumerateLineComment=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="text"in arguments[0]?arguments[0].text:"":typeof a==="undefined"&&(a="");var d="",e="";a.charAt(0)!=="/"&&(d=a.charAt(0),a=a.substring(1,a.length));a.charAt(a.length-1)==="\n"&&(e="\n",a=a.substring(0,a.length-1));this.placeholders.linecomments.push(a);return d+"@PLACEHOLDERLINECOMMENTS"+(this.placeholders.linecomments.length-1)+"END"+e};h.getPlaceholder=function(a){arguments.length===
1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="text"in arguments[0]?arguments[0].text:"":typeof a==="undefined"&&(a="");var d=a.replace(/@PLACEHOLDER([^\d]+)\d+END/,"$1").toLowerCase(),e=Number(a.replace(/@PLACEHOLDER[^\d]+(\d+)END/,"$1"));return this.placeholders[d][e]};h.preserveKeywordSpacing=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="text"in arguments[0]?arguments[0].text:"":typeof a==="undefined"&&(a="");return a.charAt(1).match(/^\w/)===
null?a.replace(/^ *([\(\)\{\}\=\:,\|\&\*\+\/\-\!\[\]\?<>\;]) */,"$1"):a.replace(/([\s\S])(\w+) *([\(\)\{\}\=\:,\|\&\*\+\/\-\!\[\]\?<>\;]) */,"$1$2 $3")};h.restoreObjectLiteral=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="text"in arguments[0]?arguments[0].text:"":typeof a==="undefined"&&(a="");var d=0,e=a.indexOf("("),b;for(b=e;b<a.length;b++)if(a.charAt(b).match(/\(/)!==null?d++:a.charAt(b).match(/\)/)!==null&&d--,d===0)break;return"{"+a.substring(e+1,
b)+"}"+a.substring(b+1,a.length)};h.withHandler=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="text"in arguments[0]?arguments[0].text:"":typeof a==="undefined"&&(a="");var d=0,e=0,b=a.indexOf("with"),f,c="",l=[],k="",g;for(f=b;f<a.length;f++)if(a.charAt(f).match(/[\(\{]/)!==null)d++,d===1&&a.charAt(f)==="{"&&(b=f);else if(a.charAt(f).match(/[\}\)]/)!==null&&(d--,d===0))if(a.charAt(f)===")")c=a.substring(a.substring(b,f).indexOf("(")+(b+1),f);else if(a.charAt(f)===
"}"){e=f;break}if(e===0)return a;d=a.substring(b+1,e);if(c.match(/as [a-zA-Z$_][\w$]*$/)!==null){b=0;g=-1;for(f=0;f<c.length;f++)c.charAt(f).match(/[\{\(\[]/)!==null&&b++,c.charAt(f).match(/[\}\)\]]/)!==null&&b--,b===0&&c.charAt(f)===","&&(l.push(c.substring(g+1,f)),g=f,f++),f===c.length-1&&l.push(c.substring(g+1,f+1));c="";for(f=0;f<l.length;f++)k+=l[f].replace(/[\s\S]*as ([a-zA-Z$_][\w$]*)$/,"$1")+",",c+=l[f].replace(/([\s\S]*[^\s]+)\s*as [a-zA-Z$_][\w$]*$/,"$1")+",";d="(function ("+k.substring(0,
k.length-1)+"){"+d+"})("+c.substring(0,c.length-1)+")";a=a.substring(0,a.indexOf("with"))+d+a.substring(e+1,a.length)}return a};h.strikeImmutableElements=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="compiler"in arguments[0]?arguments[0].compiler:this:typeof a==="undefined"&&(a=this);this.text=this.text.replace(/isn't/g,"@PLACEHOLDERISNTEND");this.text=this.text.replace(/([^\\])\/\//g,"$1@PLACEHOLDERDOUBLEFORWARDSLASHEND");this.text=this.text.replace(/[^\/\w"']\/[^\/\*\n]([^\n]*?[^\\\n])?\/[gimy]{0,4}/g,
function(d){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null&&(d="text"in arguments[0]?arguments[0].text:void 0);return a.enumerateRegex.call(a,d)});this.text=this.text.replace(/@PLACEHOLDER{1}DOUBLEFORWARDSLASHEND/g,"//");this.text=this.text.replace(/(["'])(\\\1|[^\1\n]|\\\n)*?\1/g,function(d){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null&&(d="text"in arguments[0]?arguments[0].text:void 0);return a.enumerateString.call(a,d)});this.text=this.text.replace(/\/\*[\s\S]*?\*\//g,
function(d){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null&&(d="text"in arguments[0]?arguments[0].text:void 0);return a.enumerateBlockComment.call(a,d)});this.text=this.text.replace(/\/\/[^\n]*\n/g,function(d){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null&&(d="text"in arguments[0]?arguments[0].text:void 0);return a.enumerateLineComment.call(a,d)});this.text=this.text.replace(/@PLACEHOLDER{1}ISNTEND/g,"isn't")};h.blockifyIndents=function(){if(this.blockscan){for(var a=
this.text.split("\n"),d=0,e=0,b=0;b<a.length;b++){d=a[b].replace(/^(  |\t*).*$/,"$1").replace(/  /," ").length;if(d>e)for(var f=0;f<d-e;f++)a[b-1]+="{";else if(d<e)for(f=0;f<e-d;f++)a[b-1]+="}";e=d}this.text=a.join("\n")}};h.normaliseFormatting=function(a){arguments.length===1&&typeof arguments[0]==="object"&&arguments[0]._===null?a="compiler"in arguments[0]?arguments[0].compiler:this:typeof a==="undefined"&&(a=this);this.text=this.text.replace(/\r\n/g,"\n");this.text=this.text.replace(/\t/g," ");
this.text=this.text.replace(/ +/g," ");this.text=this.text.replace(/\n /g,"\n");this.text=this.text.replace(/([^\w\$])function[ \t]*([^\w\$])/g,"$1$2");this.text=this.text.replace(/^function[ \t]*((?: *\n* *)*)([^\w\$])/,"$1$2");this.text=this.text.replace(/([^\w\$])(if|for|while|catch|switch):/g,"$1$2");this.text=this.text.replace(/(([^\w\$](if|for|while|catch|return|switch|typeof|instanceof|in|throw|finally))| *) *([\(\)\{\}\=\:,\|\&\*\+\/\-\!\[\]\?<>\;]) */g,function(d){arguments.length===1&&typeof arguments[0]===
"object"&&arguments[0]._===null&&(d="text"in arguments[0]?arguments[0].text:void 0);return a.preserveKeywordSpacing.call(a,d)});this.text=this.text.replace(/[\,\;](\s*)((?:@PLACEHOLDER[A-Z]+COMMENTS+\d+END\s*)*)(\s*)(\})/g,"$1$2$3$4");this.text=this.text.replace(/\,(\s*)((?:@PLACEHOLDER[A-Z]+COMMENTS+\d+END\s*)*)(\s*)(\))/g,"$1$2$3$4");this.text=this.text.replace(/([:\?])((?: *\n* *)*)((?:@PLACEHOLDER[A-Z]+COMMENTS+\d+END\s*)*)((?: *\n* *)*)(\S)/g,"$2$3$4$1$5")};h.convertEnglishOperators=function(){this.text=
